...
const mockEmployees: Employee[] = [
  ...
  // Add employees that report to Mike Manager
  {
    id: '5',
    employeeId: 'EMP005',
    firstName: 'David',
    ...
    documents: [
      { id: '9', name: 'Employment Contract', type: 'contract', url: '#', uploadDate: '2023-08-01', size: '2.1 MB' }
    ],
    notes: 'Promising junior developer with strong problem-solving skills.'
  },
  {
    id: '6',
    employeeId: 'EMP006',
    ...
    documents: [
      { id: '10', name: 'Employment Contract', type: 'contract', url: '#', uploadDate: '2023-10-15', size: '2.0 MB' }
    ],
    notes: 'Detail-oriented QA engineer with excellent testing skills.'
  }
];
    ...
    goals: [
      {
        id: "1",
        title: "Code Quality",
        description: "Improve code review scores",
        target: "90%",
        achievement: "92%",
        progress: 100,
        status: "completed",
      },
      {
        ...
        target: "2 mentees",
        achievement: "3 mentees",
        progress: 100,
        status: "completed",
      },
    ],
    feedback:
      "Excellent performance with strong technical skills and leadership qualities.",
...
const mockPayrollRecords: PayrollRecord[] = [
  {
    ...
    notes: "",
    processedBy: "",
    processedAt: "2024-01-31T00:00:00Z"
  },
  {
    id: "2",
    employeeId: "EMP002",
